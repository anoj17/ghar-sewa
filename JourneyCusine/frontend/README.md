...
```
### Testing performed by {  Sristi ghimire }
1. Netlify Cloud Live Test version : https://journeycusine.netlify.app
### Final Deployed Version by { Anjeel Chaudhary }
2. Vercel Cloud Live final version: https://journey-cusine.vercel.app/
### Backend API is Hosted by { Anjeel Chaudhary, Sristi Ghimire }
...
**For cloning** 
```
 git clone git@github.com:Anjeelchaudhary/JourneyCusine.git
```
...
1. **Anjeel Chaudhary** - Project Leader & Full-Stack and backend Developer Lead 
2. **Anoj Kumar Sarki** - Frontend Developer 
3. **Pradeep Pariyar** -  Work-Flow & Frontend Developer
4. **Raju Yadav** - UI Developer
5. **Sristi Ghimire** - Quality Assurance & Frontend Developer Lead
6. **Sristi Ghimire** - Custom Support & Frontend Developer
