            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <p className=" text-sm text-[#222222]">{format(startDate, 'dd/M/YYY')}</p>
                </div>
                <div
                  onClick={() => {
                  ...
                  className="px-3 py-3 border-l border-[#b9b9b9]">
                  <p className=" text-[10px] text-black font-semibold uppercase">
                    checkout
                  </p>
                  <p className=" text-sm text-[#222222]">{format(endDate, 'dd/M/YYY')}</p>
                </div>
              </div>
            </div>
          </div>
